...
per ACOS task name, each running a plain Python closure that performs
the task's computation directly. This is a flat fan-out, not a
dependency-ordered DAG: AutoGen-core's pub/sub model has no native
construct for expressing task dependencies.
