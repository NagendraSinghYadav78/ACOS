...
class Planner:
    ...
    # Static goal templates. A full LLM-backed system would generate this
    # decomposition dynamically; here it's an inspectable rule table so
    # behavior stays deterministic and auditable.
