...
TF-IDF features reduced with TruncatedSVD (scikit-learn) and indexed
with FAISS for similarity search over the resulting dense projection.
"""
...
class TfidfEmbedder:
    """TF-IDF vectorization followed by truncated SVD (LSA) to a
    fixed-dimensional dense space, indexed by FAISS."""
